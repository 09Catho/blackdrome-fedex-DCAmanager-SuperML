...
import { ArrowLeft, Brain, Clock, DollarSign, TrendingUp, AlertCircle, CheckCircle, User, Building, Calendar, RefreshCw } from 'lucide-react';
...
export default function DCACaseDetailPage() {
  ...
  if (!caseData) {
    return (
      <div className="card">
        <div className="text-gray-600">Case not found or you don't have access</div>
      </div>
    );
  }
        ...
        <div className="card bg-gradient-to-r from-purple-50 to-blue-50 border-purple-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600">Take action before deadline to ensure compliance</p>
            </div>
          ...
          <div className="card">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <div className="font-medium font-mono text-xs">{caseData.id}</div>
              </div>
              <div>
          ...
          <div className="card bg-purple-50 border-purple-200">
            ...
            <ul className="text-sm space-y-2 text-purple-800">
              ...
              {caseData.status === 'ASSIGNED' && (
                <li>• Start collection activities immediately</li>
              )}
            </ul>
          </div>
        </div>
